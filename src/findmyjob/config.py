...
class Settings(BaseSettings):
    ...
    #: Skip every model call and return canned, schema-valid responses.
    ...
    #: "anthropic" (default) or "openai" — any OpenAI-compatible /chat/completions
    #: endpoint (Groq, Gemini's OpenAI shim, Cerebras, a local Ollama, ...).
